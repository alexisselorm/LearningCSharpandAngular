...
public class ApiResult<T>
{
    ...
    ///</summary>
    private ApiResult(List<T> data, int count, int pageIndex, int pageSize, string? sortColumn, string? sortOrder, string? filterColumn = null,
        ...
        string? filterQuery = null)
    {
        ...
        {
            var order = source.Where(string.Format("{0}.StartsWith(@0)", filterColumn), filterQuery);
            source = order;
        }
    ...
    ///<summary>
    ///Page sizeNumber of items in each page
    /// </summary>
