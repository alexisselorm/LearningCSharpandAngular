...
namespace WorldCitiesAPI.Tests
{
    public class SeedController_Tests
    {
        ...
        {
            //Arrange
            //Create the option instances required by the ApplicationContext
            ...
            //create a iConfig mock instance
            ...
            //create a Role Manager instance
            ...
            var controller = new SeedController(
                context, mockEnv, userManager, mockConfiguration.Object, roleManager);
